        ...
        <?php if ((string) $tab === 'dashboard') { ?>
            ...
            if ((string) $subTab === 'verification') {
                ...
                <form method="post" action="">
                    ...
                    <p><span class="dashicons dashicons-editor-help"></span> This section allows you to set default values for your homepage.</p>
                    <p>
                        <label>Homepage Description (custom)</label><br>
